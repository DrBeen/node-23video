...
module.exports = Visualplatform = function(domain, key, secret, callback_url){
  ...
  $.call = function(method, data, access_token, access_secret){
    ...
    return new Promise(function(fulfill, reject) {
      ...
      var handleSuccess = function(res) {
        ...
        try {
          if(!(res !== null && typeof res === 'object')) res = JSON.parse(res);
          // Status might not be ok, even though the request went through
          if (!(res.status.toLowerCase() === 'ok')) return reject(res.message);
          else {
            return fulfill(res);
          }
        }
  ...
  var methods = [
    '/api/analytics/report/event',
    '/api/analytics/report/play',
    '/api/analytics/extract/play-details',
    '/api/analytics/extract/play-totals',
    '/api/album/create',
    '/api/album/delete',
    '/api/album/list',
    '/api/album/update',
    '/api/audience/realtime',
    '/api/comment/add',
    '/api/comment/delete',
    '/api/comment/list',
    '/api/photo/coordinate/add',
    '/api/photo/coordinate/delete',
    '/api/distribution/ios/push-notification',
    '/api/distribution/ios/register-device',
    '/api/distribution/ios/unregister-device',
    '/api/echo',
    '/api/license/list',
    '/api/live/create',
    '/api/live/delete',
    '/api/live/list',
    '/api/live/update',
    '/api/live/upload-image',
    '/api/live/start-recording',
    '/api/live/stop-recording',
    '/api/photo/delete',
    '/api/photo/frame',
    '/api/photo/get-upload-token',
    '/api/photo/get-replace-token',
    '/api/photo/get-transcoding-progress',
    '/api/photo/list',
    '/api/photo/rate',
    '/api/photo/redeem-replace-token',
    '/api/photo/redeem-upload-token',
    '/api/photo/replace',
    '/api/photo/section/create',
    '/api/photo/section/delete',
    '/api/photo/section/list',
    '/api/photo/section/set-thumbnail',
    '/api/photo/section/update',
    '/api/photo/subtitle/list',
    '/api/photo/update',
    '/api/photo/update-upload-token',
    '/api/photo/upload',
    '/api/player/list',
    '/api/player/settings',
    '/api/protection/protect',
    '/api/protection/unprotect',
    '/api/protection/verify',
    '/api/session/get-token',
    '/api/session/redeem-token',
    '/api/site/get',
    '/api/tag/list',
    '/api/tag/related',
    '/api/user/create',
    '/api/user/get-login-token',
    '/api/user/list',
    '/api/user/redeem-login-token',
  ];
